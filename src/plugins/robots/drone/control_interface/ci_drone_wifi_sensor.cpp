/**
 * @file <argos3/plugins/robots/drone/control_interface/ci_drone_wifi_sensor.cpp>
 *
 * @author Michael Allwright <allsey87@gmail.com>
 */

#include "ci_drone_wifi_sensor.h"
...
#ifdef ARGOS_WITH_LUA
   void CCI_DroneWifiSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_DroneWifiSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
