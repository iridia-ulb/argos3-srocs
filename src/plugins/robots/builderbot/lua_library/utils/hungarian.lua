package.preload['utils_hungarian'] = function()
   -- register module with logger
   robot.logger:register_module('utils_hungarian')
   ...
   local function create(cost_matrix_in, is_it_max_problem)
      local instance = {
      ...
      for i = 1, n do
         ...
         for j = 1, m do
            instance.cost_matrix[i][j] = 
               cost_matrix_in[i][j] or 0
         end
      end
